  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        ...
        <Card>
          <p className="text-xs font-semibold uppercase tracking-wide text-orbit-mist">
            Enrolled course
          </p>
        ...
        <Card>
          ...
          <p className="mt-2 font-mono-stat text-lg font-semibold text-orbit-ink">
            {user?.uid || '—'}
          </p>
        </Card>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        ...
        <Link to="/dashboard/profile">
          <Card hoverable>
            <h3 className="font-display text-base font-semibold text-orbit-ink">
              Your profile
            </h3>

            <p className="mt-1 text-sm text-orbit-ink-soft">
              Update your contact and parent details.
            </p>
          </Card>
        </Link>
        ...
        <Link to="/dashboard/subscription">
          <Card hoverable>
            ...
            <p className="mt-1 text-sm text-orbit-ink-soft">
              Upgrade your tier and unlock more exams.
            </p>
          </Card>
        </Link>
        ...
        <Link to="/dashboard/certificates">
          <Card hoverable>
            ...
            <p className="mt-1 text-sm text-orbit-ink-soft">
              Download certificates you've earned.
            </p>
          </Card>
        </Link>
