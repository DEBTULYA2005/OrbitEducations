...
export default function CourseDetailPage() {
  ...
  if (isError || !course) {
    return (
      <div className="container-orbit py-16">
        <ErrorMessage>
          This course couldn't be found. It may have been moved or removed.
        </ErrorMessage>

        <Link
          to="/courses"
          className="mt-4 inline-block text-sm font-semibold text-orbit-blue-600"
        >
          ← Back to all courses
        </Link>
      </div>
  ...
  return (
    <section className="relative isolate overflow-hidden py-14">
      ...
      {course.image_url && (
        <div
          className="absolute inset-0 -z-20 scale-110 bg-cover bg-center bg-no-repeat blur-md"
          style={{
      ...
      <div className="container-orbit">
        ...
        <Link
          to="/courses"
          className="text-sm font-semibold text-orbit-blue-600"
        >
          ← Back to all courses
        </Link>
        ...
        <div className="mt-6 grid grid-cols-1 gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            ...
            <h1 className="mt-3 font-display text-3xl font-bold text-orbit-ink sm:text-4xl">
              {course.title}
            </h1>
            ...
            {course.syllabus && (
              <div className="mt-8">
                ...
                <h2 className="font-display text-xl font-semibold text-orbit-ink">
                  What you'll cover
                </h2>
                ...
                <ul className="mt-3 flex flex-col gap-2">
                  ...
                  {course.syllabus.map((item) => (
                    <li
                      key={item}
                      className="flex items-start gap-2 text-sm text-orbit-ink-soft"
                    >
                      <svg
                        width="16"
                        height="16"
                      ...
                      >
                        <path
                          d="M3.5 8.3l2.7 2.7 6.3-6.3"
                          stroke="var(--color-orbit-green-500)"
                          strokeWidth="1.6"
                          strokeLinecap="round"
          ...
          <Card className="h-fit lg:col-span-2">
            ...
            <h2 className="font-display text-lg font-semibold text-orbit-ink">
